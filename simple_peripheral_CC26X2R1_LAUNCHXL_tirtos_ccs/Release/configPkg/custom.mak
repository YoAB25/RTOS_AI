...
linker.cmd: package/cfg/simple_peripheral_app_pem4f.xdl
	$(SED) 's"^\"\(package/cfg/simple_peripheral_app_pem4fcfg.cmd\)\"$""\"C:/Workspace_IA_YAB_LSD/simple_peripheral_CC26X2R1_LAUNCHXL_tirtos_ccs/Release/configPkg/\1\""' package/cfg/simple_peripheral_app_pem4f.xdl > $@
