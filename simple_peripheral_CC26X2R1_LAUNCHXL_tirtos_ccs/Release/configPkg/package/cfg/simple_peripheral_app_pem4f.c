 ...
 */
xdc__META(__ASM__, "@(#)__ASM__ = C:/Workspace_IA_YAB_LSD/simple_peripheral_CC26X2R1_LAUNCHXL_tirtos_ccs/Release/configPkg/package/cfg/simple_peripheral_app_pem4f");
